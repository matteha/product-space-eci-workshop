...
The product space is, as well as its derivations / related measures such as economic complexity and the Growth's annual rankings of countries by economic complexity (at [[https://atlas.cid.harvard.edu]]), are based on trade data between countries.
...
How does the data look like? We will explore the data in Python using the 'pandas' (most popular Python package for data analysis).
...
We use the original trade dataset ('df_orig') that is loaded into memory:
